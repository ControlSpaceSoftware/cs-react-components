	...
	var alreadyHaveAccount = function alreadyHaveAccount() {
		if (_this.state.stateName !== 'SignIn') {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_FlatButton2.default, { style: { border: 0 }, labelStyle: { textTransform: 'initial', padding: 8, fontWeight: 100 }, label: 'Got an account?', onClick: function onClick() {
	...
	var createAccount = function createAccount() {
		if (_this.state.stateName !== 'SignUp') {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_FlatButton2.default, { labelStyle: { textTransform: 'initial', padding: 8, fontWeight: 100 }, label: 'Need an account?', onClick: function onClick() {
