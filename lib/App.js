		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_components.SignUpSignInSignOut, { style: { display: this.state.hideSignUp ? 'none' : 'inline-block' },
						authService: authService,
						authServiceStateMachine: _AuthServiceStateMachine2.default,
						onStateChange: this.onAuthStateChange,
						stateName: this.state.stateName,
						onClose: function onClose() {
							console.log('close sign up');
							_this2.setState({ hideSignUp: true });
							setTimeout(function () {
								console.log('open sign up');
								_this2.setState({ hideSignUp: false });
							}, 3000);
						}
					}),
					_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_components.LoadingIndicator, { show: true })
					)
				)
			);
		}
