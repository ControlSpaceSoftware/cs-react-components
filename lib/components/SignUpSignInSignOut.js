...
var SignUpSignInSignOut = function (_Component) {
	...
	_createClass(SignUpSignInSignOut, [{
		key: 'onStateChange',
		value: function onStateChange(stateName, serviceData, actionResult, messages) {
...
SignUpSignInSignOut.defaultProps = {
	stateName: 'SignIn',
	userInfo: {},
	onStateChange: function onStateChange(stateName, serviceData, actionResult, messages) {
		return console.log('onStateChange', stateName, serviceData, actionResult, messages);
	}
};
