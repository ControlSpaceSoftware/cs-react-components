...
var StateMachine = function (_Component) {
	...
	function StateMachine(props) {
		...
		_this.renderStateMachine = (0, _renderStateMachine2.default)(_this, _this.props.stateMachine);
		return _this;
	}
...
StateMachine.propTypes = {
	...
	serviceData: _react.PropTypes.object,
	stateMachine: _react.PropTypes.object.isRequired,
	startState: _react.PropTypes.string,
